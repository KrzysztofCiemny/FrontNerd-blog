...
const styles = {
  ...
  contentWrapper:
    'content-max-width lg:items-center flex flex-col lg:flex-row gap-5 lg:gap-16 2xl:gap-[6.25rem]',
      ...
      <div className={contentWrapper}>
        <div className={textWrapper}>
          ...
          <p className={paragraph}>
            Jestem frontend developerem i aktualnie pracuję w{' '}
            <Link href="https://publicislepont.com/" className={link} target="_blank">
              {' '}
              Publicis&nbsp;Le&nbsp;Pont
            </Link>
            . Programowaniem zajmuję się od około 4 lat. W tym czasie zdążyłem poznać kawałek świata
            frontendu. Na ten moment bliżej mi do Reacta/Nexta, ale z tyłu głowy zawsze mam Vue, z
            którym rozpocząłem swoją zawodową przygodę.
          </p>
          <p className={paragraph}>
          ...
          <p className={paragraph}>Więcej można dowiedzieć się na moich socialach. 😋</p>
          <Socials />
        </div>
        <Image
          src="/images/aboutMe/PhotoOfMe.png"
          alt="picture of the author of this blog"
          width={593}
          height={844}
          priority={true}
          className={image}
