...
const styles = {
  ...
  container:
    'grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-16 lg:gap-x-9 my-mobileY lg:my-desktopY',
...
const AllArticlesSection = () => {
  ...
  const filteredPosts =
    selectedCategory && selectedCategory !== allArticlesCategory
      ? allPostsMetadata.filter((post) => post.category === selectedCategory)
      : allPostsMetadata;
