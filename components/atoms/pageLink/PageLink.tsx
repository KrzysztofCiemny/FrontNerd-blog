...
const PageLink = ({ children, to, dark }: any) => {
  return (
    <Link href={to} className={`flex items-center gap-3 group no-underline tracking-wide font-medium cursor-pointer z-[3] max-w-[15rem] ${dark ? 'text-black' : 'text-lightBlue'}`}>
      {children}
